...
#The columns names are the data for the U.S. and they have an x because they can't be numbers. 
...
#The column names are still numbers and the population colomns turned into character values because of the space. in the U.S. data. 
...
# Now that we made the column names correct, we still need to change the pct column to numeric values and move the second set of states to the same column as the first set. 
...
# We still have to take the periods and spaces out of the state column and take the space out of the top percent values so that they appear. 
...
Now we have to take the state values and delete the periods and the space in "U .S."
