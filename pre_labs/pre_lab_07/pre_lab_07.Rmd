...
Howard County clears all others in median household income. 
```{r}
md |>
...
Is the difference between Calvert and Montgomery significant? No not significant. 

Is the difference between Howard and everyone else significant? Yes more significant. 
...
Kent County, Allegany County, and Baltimore City are the top three highest increasing counties in median income. Allegany County is the most interesting increase to me because its sort of the middle of nowhere. At least Kent County is on the bay and is across the bay from Baltimore and Annapolis. Allegany County is in the panhandle and does not even house Deep Creek Lake. 
...
Utah has the highest percent of adherents, New Hampshire has the lowest. 
...
Wealtheir counties typically have lower percentage of adherents. 
