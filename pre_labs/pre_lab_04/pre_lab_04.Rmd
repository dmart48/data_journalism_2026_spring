...
#In the orginial data, there are a lot of repeating grantees that are not spelled the same way, which makes the true count hard to track. 
...
#One difference is that Washington County Museum of Fine Arts is now uppercase. Another difference is that Fair Hill Farm, Inc. no longer has comma and period.
...
# 1) Both Walter P Carter Child Care Center entries match. 2) Washington Adventist University was made lowercase. 3)Washinton College was made lowercase. 
...
#There is almost no difference between the last table and this table. 
